...
class InputFileGenerated(Object):
    ...
    Args:
        ...
        conversion (:obj:`str`):
            String specifying the conversion applied to the original file; must be persistent across application restartsConversions beginning with '#' are reserved for internal TDLib usage
